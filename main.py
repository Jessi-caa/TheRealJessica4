...
Infinite loop:
    ...
    3. IF wake word is detected (in my case Gideon):
        ...
        b. Audio reply with "how can i help you"
        c. Start reading from pyaudio stream for next 5 sec for question.
        d. Convert the audio to text using voice_command_processor().
        e. Process the text using process_text() method from response.py.
        f. once the processing done, it will remove all the files from the output directory.
"""
